...
const Homepage = () => {
    ...
    return (
        <div id="homepage" className="flex flex-col flex-wrap h-[100vh] pb-5 justify-center items-center ">
            <motion.div className="  h-52 w-52 ">
                <motion.img
                    drag
                    dragConstraints={{ left: -500, right: 500, top: 0, bottom: 0 }}
                    src={Untitled} alt="Your Image Alt Text" className="rounded-full" />
            </motion.div>
            <motion.div className="mt-10 text-3xl flex justify-between items-center  name"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <div className="mt-4">
                <motion.h1 className=" font-bold namejava text-center text-4xl text-[#fbc530]"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
            ...
            <motion.div c
                ...
                className=" mt-5 font-work w-[40%] text-xl text-center">
                <p className="text-center">
                    Soon-to-be a Computer Science graduate with a zeal for technology.
                    Open to learn new things and getting involved with new projects.
                </p>
            </motion.div>
            <div className=" flex mt-16 w-[40%] font-bold justify-around items-center">
                <motion.button
                onClick={handleDownload}
                    ...
                    className=" w-[30%] rounded h-10 bg-[#ff6835] flex justify-center items-center">
                ...
                <motion.button
                    ...
                    className=" w-[30%] rounded h-11 bg-[#171236] flex justify-center  items-center">
                    <FontAwesomeIcon className="text-xl mr-2" icon={faGithub} /> My Projects
                </motion.button>
            </div>
        </div>
    );
